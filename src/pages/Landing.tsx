    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 selection:bg-cyan-500 selection:text-slate-950 font-sans relative overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              ...
              onTouchStart={warmAuthAndPortalBundles}
            >
              <Button className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-slate-950 font-semibold shadow-lg shadow-cyan-500/25 border-0">
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight leading-[1.15] font-display">
              Refer Patients With <span className="bg-gradient-to-r from-cyan-400 via-teal-300 to-blue-500 bg-clip-text text-transparent">Clarity</span>. <br />
              Treat Them With <span className="bg-gradient-to-r from-blue-400 via-indigo-300 to-cyan-300 bg-clip-text text-transparent">Speed</span>.
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-2">
              <Link
                ...
                onTouchStart={warmAuthAndPortalBundles}
              >
                <Button size="lg" className="w-full sm:w-auto h-13 px-8 text-base bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-slate-950 font-bold shadow-xl shadow-cyan-500/20 rounded-xl">
                  Get Started Free
                </Button>
              </Link>
              <Link
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-8 border-t border-slate-800/80">
              <div className="text-left">
                <div className="text-xl font-bold text-cyan-400 font-mono">&lt; 1 min</div>
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative rounded-2xl overflow-hidden border border-slate-700/60 bg-slate-900/80 shadow-2xl shadow-cyan-950/50 group">
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-slate-900/90 backdrop-blur-md border border-slate-700/80 p-4 rounded-xl shadow-xl flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-lg bg-cyan-500/20 border border-cyan-500/30 flex items-center justify-center text-cyan-400">
      ...
      <section className="py-20 bg-slate-900/60 border-y border-slate-800/80 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <h2 className="text-xs uppercase font-bold tracking-widest text-cyan-400">Built for Hospital & Clinic Workflows</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Card 1 */}
            <div className="bg-slate-950/80 border border-slate-800 rounded-2xl p-7 hover:border-cyan-500/50 transition duration-300 shadow-lg relative group">
              <div className="h-12 w-12 rounded-xl bg-cyan-500/10 border border-cyan-500/20 flex items-center justify-center text-cyan-400 mb-6 group-hover:bg-cyan-500 group-hover:text-slate-950 transition duration-300">
              ...
              <ul className="space-y-2 text-xs text-slate-300">
                <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-cyan-400" /> Real-time triage updates</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-cyan-400" /> Multi-department routing</li>
              </ul>
            </div>

            {/* Card 2 */}
            <div className="bg-slate-950/80 border border-slate-800 rounded-2xl p-7 hover:border-blue-500/50 transition duration-300 shadow-lg relative group">
              <div className="h-12 w-12 rounded-xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center text-blue-400 mb-6 group-hover:bg-blue-500 group-hover:text-slate-950 transition duration-300">
              ...
              <ul className="space-y-2 text-xs text-slate-300">
                <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-blue-400" /> Automatic deduplication</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-blue-400" /> Department staff management</li>
              </ul>
            </div>

            {/* Card 3 */}
            <div className="bg-slate-950/80 border border-slate-800 rounded-2xl p-7 hover:border-indigo-500/50 transition duration-300 shadow-lg relative group">
              <div className="h-12 w-12 rounded-xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center text-indigo-400 mb-6 group-hover:bg-indigo-500 group-hover:text-slate-950 transition duration-300">
              ...
              <ul className="space-y-2 text-xs text-slate-300">
                <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-indigo-400" /> Full timeline audit logs</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-indigo-400" /> Role-gated portal security</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 max-w-7xl mx-auto px-6">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <h2 className="text-xs uppercase font-bold tracking-widest text-cyan-400 mb-2">3 Simple Steps</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-6 relative">
            <span className="text-5xl font-extrabold font-mono text-cyan-500/20 block mb-2">01</span>
